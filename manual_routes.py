...
# Owner's content, cleaned up: correct street spelling (matching the
# real names used for routing above), fixed grammar/capitalization/
# punctuation, natural phrasing -- owner explicitly asked for this, not
# a verbatim copy-paste of the transcript (typos and all). Every real
# fact is preserved: stop sign / light ordinals, turn directions, and
# exactly where each maneuver (parking, 3-point turn, uphill/downhill,
# emergency stop) happens. Real distance/duration/traffic-control/speed-
# limit are filled in per line by align_transcript() below, pulled from
# OSRM's own steps -- not guessed, not left blank.
TRANSCRIPT = {
    ("smithsfalls", "G2", 0): [
        "Turn right after exiting your parking spot. (Park in reverse when you reach the test centre.)",
        "At the stop sign, turn left onto Percy St",
        "Parallel park on Percy St",
        "Turn left onto Toulon St",
        "At the stop sign, turn right onto Brockville St",
        "Turn left onto Davidson St W",
        "Stop at the stop sign on Davidson St W",
        "Park curbside on Davidson St W, uphill",
        "At the stop sign, turn right onto Lavinia St",
        "Perform a three-point turn on Lavinia St",
        "At the stop sign, turn right onto St. Lawrence St",
        "Continue onto Andrews Ave",
        "At the stop sign, turn left onto Broadview Ave W",
        "At the light, use the filter lane to turn right onto Brockville St",
        "At the intersection, turn left onto Van Horne Ave",
        "Continue onto Percy St",
        "Pull into the DriveTest Centre at the intersection",
    ],
    ("smithsfalls", "G", 0): [
        "At the stop sign, turn right onto Van Horne Ave",
        "At the stop sign, turn left onto Brockville St",
        "Continue onto County Road 29",
        "Continue onto Brockville St",
        "Continue onto County Road 29",
        "At the light, turn left onto Eric Hutcheson Rd",
        "Continue on Eric Hutcheson Rd",
        "At the stop sign, turn left onto Jasper Road",
        "Continue onto Jasper Ave",
        "Continue on Jasper Road",
        "At the stop sign, turn left onto Old Slys Rd",
        "Continue on Old Slys Rd",
        "Continue onto Jasper Ave",
        "At the light, turn right onto Beckwith St",
        "At the light, turn right onto Chambers St",
        "At the flashing red light, turn left onto Market St",
        ...
        "Continue onto Brockville St",
        "Continue onto County Road 29",
        "At the light, turn left onto Broadview Ave",
        "Continue on Broadview Ave",
    ...
    ("canotek", "G2", 0): [
        ...
        "At the 3rd light, turn left onto Ogilvie Rd",
        "At the light, turn right onto Appleford St",
        "Perform an emergency stop on Appleford St",
        "Turn right onto Elmridge Dr",
        "Perform a parallel park and a three-point turn on Elmridge Dr",
        ...
        "At the stop sign, come to a complete stop",
        "At the end of the road, turn left onto Blair Rd",
    ...
    ("canotek", "G2", 1): [
        ...
        "At the stop sign, turn left onto Miss Ottawa St",
        "At the stop sign, turn left onto East Acres Rd",
        "Turn left onto Shefford Rd",
        "At the light, continue straight",
        "Pull into the DriveTest Centre at the intersection",
    ],
    ("canotek", "G2", 2): [
        "Continue straight onto Loyola Ave",
        "At the stop sign, turn right onto Eastvale Dr",
        "Continue on Eastvale Dr",
        "Turn left onto Grafton Crescent",
        "On Grafton Crescent, perform an uphill or downhill park",
    ...
    ("canotek", "G", 0): [
        ...
        "Continue onto Regional Rd 174",
        "Exit onto Boul. Jeanne-d'Arc Blvd",
        ...
        "At the next two lights, continue straight",
        "At the third light, turn right onto the highway ramp",
        "Continue on the highway",
        "Exit onto Ch. de Montreal Rd",
        "Keep to the right lane onto Montreal Rd",
        "Continue on Montreal Rd",
    ...
    ("canotek", "G", 1): [
        ...
        "Continue straight through the next five lights",
        "At the 7th light, turn left toward Highway 417",
        "At the light, continue straight",
        "At the 2nd light, turn left onto the highway ramp",
        "Continue on the highway",
        "Exit onto Ch. de Montreal Rd",
        "At the light, turn left onto Montreal Rd",
        "At the light, continue straight",
        "At the 2nd light, turn right onto Shefford Rd",
        "At the light, continue straight",
        "Pull into the DriveTest Centre at the intersection",
    ],
    ("walkley", "G2", 0): [
        "There's a lot behind the centre for a parallel park and a three-point turn",
        "Turn right onto Walkley Rd",
        ...
        "Midway through Fairlea Cres, perform an uphill/downhill park",
        ...
        "At the stop sign, turn left onto Cedarwood Dr",
    ...
    ("walkley", "G2", 1): [
        ...
        "When safe, turn right onto Walkley Rd",
        "Continue on Walkley Rd",
        "At the first light, continue on Walkley Rd",
        ...
        "Perform an uphill/downhill park on Briar Hill Dr",
        "Continue on Briar Hill Dr",
        ...
        "Continue on Heron Rd",
        "At the light, use the filter lane to turn right onto Walkley Rd",
        "Continue on Walkley Rd",
        "At the light, continue on Walkley Rd",
        "Turn onto the median and, when safe, turn left into the DriveTest Centre",
    ],
    ("walkley", "G2", 2): [
        "There's a lot behind the centre for a parallel park and a three-point turn",
        "Turn left onto the median",
    ...
    ("walkley", "G", 0): [
        ...
        "When safe, turn right onto Walkley Rd",
        "Continue on Walkley Rd",
        "Through several lights, keep straight on Walkley Rd",
        "After crossing the bridge, move to the left lane and turn left onto the Airport Parkway on-ramp",
        "Continue on Airport Parkway",
        "Exit at Uplands Dr",
        "At the light, turn left onto Uplands Dr",
        "Continue on Uplands Dr",
        "At the light, turn left onto the Airport Parkway on-ramp",
        "Continue on Airport Parkway",
        "Exit at Walkley Rd",
    ...
    ("walkley", "G", 1): [
        ...
        "After crossing the bridge, move to the left lane and turn left onto the Airport Parkway on-ramp",
        "Continue on Airport Parkway",
        "Exit at Hunt Club Rd",
        "Use the filter lane onto Hunt Club Rd",
        "At the light, continue on Hunt Club Rd",
        "At the 2nd light, turn right onto Uplands Dr",
        "Continue on Uplands Dr",
        "At the stop sign, turn right onto Paul Anka Dr",
        "Continue on Paul Anka Dr",
        "At the light, turn right onto McCarthy Rd",
        "Continue on McCarthy Rd",
        "At the stop sign, continue on McCarthy Rd",
        "At the light, turn left onto Hunt Club Rd",
        "Continue on Hunt Club Rd",
        "At the light, turn left onto the Airport Parkway on-ramp",
        "Continue on Airport Parkway",
        "Exit at Walkley Rd",
        "At the light, turn right onto Walkley Rd",
    ...
    ("walkley", "G", 2): [
        ...
        "Turn right onto Banff Ave",
        "Continue on Banff Ave",
        ...
        "At the intersection, turn right onto the Airport Parkway on-ramp",
        "Continue on Airport Parkway",
        "Exit at Walkley Rd",
        "At the light, turn right onto Walkley Rd",
        "Continue on Walkley Rd",
...
def align_transcript(lines, osrm_steps, streets):
    ...
    transcript line(s) belong to each street. Every line describing that
    street -- the turn onto it AND every "continue on X" after it -- gets
    that same real leg's numbers (there's only one real distance/duration
    known for the whole leg, not a sub-split per line; showing it on
    every line covering that leg is filling the columns in as asked, not
    fabricating a different number per row)."""
    # `streets` (used for junction resolution) is finer-grained than
    # OSRM's own real steps -- an alternating "Brockville St/County Road
    # 29/Brockville St/County Road 29" jog in `streets` (real junction
    # connectivity requirement) can be ONE real "County Road 29" leg on
    # the ground, with no distinct Brockville step of its own. An
    # unbounded forward scan for each streets[i] in turn (old approach)
    # jumps straight past the correct nearby step to a LATER, unrelated
    # one with the same name and never recovers -- every line after that
    # point silently lost its real numbers. Bounded lookahead + a
    # forward-fill pass (entries with no direct match inherit the next
    # real step found -- they're driven on the way to it) fixes this.
    step_for_street = {}
    sj = 0
    LOOKAHEAD = 4
    for i, s in enumerate(streets):
        match = None
        for k in range(sj, min(sj + LOOKAHEAD, len(osrm_steps))):
            if _mentions(osrm_steps[k]["instruction"], s):
                match = k
                break
        if match is not None:
            step_for_street[i] = osrm_steps[match]
            sj = match + 1
    next_step = None
    for i in range(len(streets) - 1, -1, -1):
        if i in step_for_street:
            next_step = step_for_street[i]
        elif next_step is not None:
            step_for_street[i] = next_step
    ...
    for line in lines:
        ...
        # consecutive real legs its own way (e.g. an alternating
        # "Brockville/County Road 29/Brockville/County Road 29" jog in
        # `streets` can be ONE real "County Road 29" leg on the ground),
        # so `streets` can have entries with no real step of their own.
        # A 1-ahead window gets permanently stuck the first time that
        # happens; every line after it silently loses its real numbers.
        for j in range(si, min(si + 6, len(streets))):
            if _mentions(line, streets[j]):
                street_i = j
                si = j
                break
